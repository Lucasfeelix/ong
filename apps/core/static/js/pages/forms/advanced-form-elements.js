$(function () {
    ...
    //Mobile Phone Number
    $demoMaskedInput.find('.mobile-phone-number').inputmask('(99) 9 9999-9999', { placeholder: '(__) _ ____-____' });
    //Phone Number
    ...
    //Real Money
    $demoMaskedInput.find('.money-real').inputmask('R$ *.***.**', { placeholder: 'R$ _.___.__' });
    ...
    //CEP
    $demoMaskedInput.find('.cep').inputmask('99.999-999', { placeholder: '__.___-___' });
